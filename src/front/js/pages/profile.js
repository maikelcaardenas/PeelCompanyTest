        ...
        <div className="container-fluid text-center p-0">
            ...
            <div className="d-flex justify-content-center flex-wrap my-4">
                <img
                    ...
                    style={{ borderRadius: "7px", marginRight:"10'x" }}
                    src={vtr}
                    alt="Victor"
                />
                <img
            ...
            >
                <div className="col-12 col-md-6 text-left p-3">
                    <h1>
            ...
            <div className="container d-flex flex-wrap justify-content-around my-4">
                <div className="d-grid align-items-start m-2" style={{ flexBasis: "30%", minWidth: "280px" }}>
